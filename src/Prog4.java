...
/* Prog4 class: obtains input file and passes it on to Database class     */
/**************************************************************************/
...
public class Prog4 {
	...
	public static void main(String [] args){
		...
		//constant for case to print database to disk
		final String PRINT_TO_DISK = "7";
		//constant for case to exit the application
		final String RELOAD_DATABASE = "8";
		final String EXIT = "9";
		...
		while ( true ){
			System.out.println("\nCurrent available commands:\n"
					...
					+ "5 --> Add a station\n"
					+ "6 --> Remove a station\n"
					+ "7 --> Print all stations to a file\n"
					+ "8 --> Reinitialize the database\n"
					+ "9 --> Exit\n\nYour choice?");
			...
			case PRINT_TO_DISK:
				try{
					System.out.println("Enter file name to print to:");
					//skip new line
					in.nextLine();
			...
			case RELOAD_DATABASE:
				System.out.println("Enter file name of database:");
				String newInputFileName = in.next();
